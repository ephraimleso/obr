    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered">Parent Name</h5>
          <li class="mt">
            <a href="index.php">
              ...
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="frm_registerlearner" method="post" action="">
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="txtNameSurname" name="txtNameSurname" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" name="btnSubmit" data-toggle="modal" data-target="#myModal">Submit</button>
